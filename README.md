...
以下の3つのモードで、リスニング・スピーキング・ライティングをバランスよく鍛えることを目的としています。
...
英語レベル選択：初級者 / 中級者 / 上級者（現状はUIのみ、ロジック拡張前提）
...
LangChain ConversationChain で応答生成
...
LLMが元の英文 vs ユーザー発話を比較し、評価コメントを生成
...
ユーザーは画面下部のチャット欄に英文を入力

LLMが問題文 vs 入力文を比較し、日本語で評価＋アドバイスを表示
